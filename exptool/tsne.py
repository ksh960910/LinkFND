...
"""Show T-SNE"""
'''gowalla'''
# user_embedding = np.load('../embedding/'+'gowalla_eps0.2_lamb0.1'+'_user.npy')
# item_embedding = np.load('../embedding/'+'gowalla_eps0.2_lamb0.1'+'_item.npy')
'''book'''
user_embedding = np.load('../embedding/'+'m4_amazon-book_eps0.2_lamb1.0'+'_user.npy')
item_embedding = np.load('../embedding/'+'m4_amazon-book_eps0.2_lamb1.0'+'_item.npy')
...
# f, axs = plt.subplots(2, 1, figsize=(16,14),gridspec_kw={'height_ratios': [3, 1]})
...
# plt.savefig('KDEGOWALLA.png', dpi=300)
...
plt.savefig('TSNEBOOK.png', dpi=500)
